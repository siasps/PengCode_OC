...
-(void) setBadgeValue:(NSString *)badgeValue
{
    ...
    if (!badgeValue || [badgeValue isEqualToString:@""] || ([badgeValue isEqualToString:@"0"] && self.shouldHideBadgeAtZero)||[NSString isNULLString:badgeValue]) {
        [self removeBadge];
    } else if (!self.badge) {
...
- (void)setIsTitlteLeftImageRight:(BOOL)isTitlteLeftImageRight{
    if (isTitlteLeftImageRight) {
